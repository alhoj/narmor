...
sub=subs[int(sys.argv[1])-1] # select one subject based on the index given as command line argument
#nsubs=len(subs)
res = str(sys.argv[2]) # defined in the command line; second agrument
...
## do CCA
reg_param = float(sys.argv[3]) # Regularization parameter; defined in the third agrument of the command line
